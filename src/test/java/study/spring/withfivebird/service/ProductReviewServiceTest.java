...
public class ProductReviewServiceTest {
    ...
    public void testD() {
        ...
        try {
            ...
            log.debug("말을 포함하는 제품후기 이름을 갖는 데이터 수: " + count);
        } catch (Exception e) {
            log.error(e.getLocalizedMessage());
            e.printStackTrace();
        }
    ...
    public void testE() {
       ...
       input.setProduct_review_title("정말 이뻐요");
       input.setProduct_review_content("후회 안하실 겁니다.");
       input.setProduct_review_hit(4);
       input.setProduct_review_reg_date("2020-08-31");
