...
//		
//		try {
//			output = heartService.getHeartList(input);
//			
//			for(Heart item : output) {
...
//		
//		try {
//			count = heartService.getHeartCount(null);
...
//		Heart input = new Heart();
//		input.setHeart_no(1);
//		input.setProduct_no(5);
//		
//		try {
//			count = heartService.getHeartCount(input);
...
//		
//		input.setUser_no(3);
//		input.setProduct_no(21);
//		
//		int output = 0;
//		
//		try {
//			output = heartService.addHeart(input);
//			log.debug("저장된 데이터 수 : " + output);
//			// [중요] 생성된 PK값은 MyBatis에 의해 입력 파라미터의 해당 멤버변수에  셋팅된다.
//			log.debug("생성된 PK값 : "+ input.getHeart_no());
//		} catch (Exception e) {
//			log.error(e.getLocalizedMessage());
//			e.printStackTrace();
//		}
...
//		input.setHeart_no(6);
//		input.setUser_no(4);
//		input.setProduct_no(25);
//		
//		int output = 0;
//		
//		try {
//			output = heartService.editHeart(input);
...
//		
//		try {
//			output = heartService.deleteHeart(input);
