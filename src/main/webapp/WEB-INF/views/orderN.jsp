		...
		<div id="content">
			<div id="payCheck">
				<div id="deliveryLine">
					...
					<div id="noMember" class="pLine pull-right">비회원</div>
				...
				<form id="deliveryInfo">
					...
					<div class="form-info clearfix">
						...
						<div id="addressDetail">
							<ul>
								<li><input type="text" name="postcode"
									id="postcode" value="" disabled="disabled" /><span><button
											id="postButton" class="btn btn-warning" type="button"
											data-addr1="#addr1" data-addr2="#addr2"
											onclick=post()>우편번호</button></span></li>
								<li><input type="text" 
									id="addr1" name="addr2" value="" disabled="disabled" /></li>
								<li><input type="text" 
									id="addr2" name="addr2" value="" /></li>
							</ul>
							<div id="wrap" >
				...
				<form>
					...
					<!-- <div id="save" class="form-info clearfix">
						...
						<div class="pull-right">
							...
							<ul>
								<li><span><input id="saveUse" type="text" value="0" /></span><button
											id="saveButton" type="button" class="btn btn-warning">적용</button></li>
							</ul>
						</div>
					</div> -->
				</form>
			...
			<div id="infoCheck" class="clearfix">
				<input id="payCheck" type="checkbox" /> 결제정보를 확인하였으며, 구매진행에 동의합니다. <span><button
						id="payButton" type="button" class="btn btn-warning"
						>결제하기</button></span>
			</div>
		</div>
